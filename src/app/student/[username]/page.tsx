    ...
    <Flex w="100%" p="2rem" direction="column" gap="xl">
      <Flex w="100%" align="center" gap="md">
        ...
        <Flex direction="column">
          <Title order={2}>Full Display Name</Title>
      ...
      <SimpleGrid cols={4}>
        <Card withBorder shadow="md" radius="lg" padding="lg">
          ...
          <Flex align="center" justify="space-between">
            <List mt="md">
              <ListItem icon={<IconSchool />}>15/35 Lessons</ListItem>
              <ListItem icon={<IconBook />}>12/30 Assignments</ListItem>
            </List>
            <RingProgress
              sections={[{ value: 86, color: "blue" }]}
              label={<Text ta="center">86%</Text>}
              size={100}
              thickness={10}
              roundCaps
            />
